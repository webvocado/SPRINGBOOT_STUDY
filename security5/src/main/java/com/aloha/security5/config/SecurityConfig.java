...
public class SecurityConfig {
     ...
     * 
     *      ✅ 인가 (Authorization)
     *      : 사용자의 권한을 확인하여 권한에 따라 자원의 허용 범위를 구분하여 허락하는 것
     */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        //      passwordParameter()     : 비밀번호 요청 파라미터 이름 지정      ("password")
        ...
        // tokenRepository()    : 토큰을 저장할 저장소 지정 (데이터소스 포함한 저장소객체)
    ...
    public PersistentTokenRepository tokenRepository() {
        ...
        repositoryImpl.setDataSource(dataSource); // mysql :3306/joeun joeun/123456 정보를 담고 있다.
